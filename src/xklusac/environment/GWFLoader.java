...
public class GWFLoader extends GridSim {
    ...
    public void body() {
        ...
        super.sim_schedule(this.getEntityId("Alea_Job_Scheduler"), earliest_end_time, AleaSimTags.SUBMISSION_DONE, (submitted));
        Sim_event ev = new Sim_event();
        sim_get_next(ev);
    ...
    private ComplexGridlet readGridlet(int j) {
        ...
        ComplexGridlet gl = new ComplexGridlet(id, "J", job_limit, (length), estimatedLength, 10, 10,
                null, null, arrival, deadline, 1, numCPU, 0.0, queue, properties, perc, 0, numNodes, ppn,0, null);
