...
public class MWFLoader extends GridSim {
    ...
    public void body() {
        ...
        super.sim_schedule(this.getEntityId("Alea_Job_Scheduler"), 0.0, AleaSimTags.SUBMISSION_DONE, (submitted));
        Sim_event ev = new Sim_event();
        sim_get_next(ev);
    ...
    private ComplexGridlet readGridlet(int j) {
        ...
        arrival = Math.round(Double.valueOf(arrival) / multiplier);
        ...
        ComplexGridlet gl = new ComplexGridlet(id, user, job_limit, (length), estimatedLength, 10, 10,
                null, null, arrival, deadline, 1, numCPU, estimatedMachine, queue, properties, perc, 0, numNodes, ppn,0, null);
