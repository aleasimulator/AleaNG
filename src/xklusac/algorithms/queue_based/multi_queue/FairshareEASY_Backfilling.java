 ...
 */
public class FairshareEASY_Backfilling implements SchedulingPolicy {

    private Scheduler scheduler;

    public FairshareEASY_Backfilling(Scheduler scheduler) {
    ...
    public int selectJob() {
        ...
        if (currently_free_CPUs == 0) {
            System.out.println("EASY terminated immediately due to no free resources: " + currently_free_CPUs + " free CPUs.");
            return 0;
        }
