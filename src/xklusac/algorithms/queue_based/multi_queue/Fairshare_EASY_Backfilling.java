...
/**
 * Class Fairshare_EASY_Backfilling<p>
 * Implements EASY BAckfilling with fairshare.
 *
 * @author Dalibor Klusacek
 */
public class Fairshare_EASY_Backfilling implements SchedulingPolicy {

    private Scheduler scheduler;

    public Fairshare_EASY_Backfilling(Scheduler scheduler) {
