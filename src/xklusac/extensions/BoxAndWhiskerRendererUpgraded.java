 ...
 * {@code BoxAndWhiskerChartDemo1.java} program included in the JFreeChart Demo
 * Collection:
 * <br><br>
 * <img src="doc-files/BoxAndWhiskerRendererSample.png"
 * alt="BoxAndWhiskerRendererSample.png">
 */
public class BoxAndWhiskerRendererUpgraded extends AbstractCategoryItemRenderer
    ...
    /**
     * A flag that, if {@code true}, causes the whiskers to be drawn using the
     * outline paint for the series. The default value is {@code false} and in
     * that case the regular series paint is used.
     */
     ...
     * Default constructor.
     */
    public BoxAndWhiskerRendererUpgraded() {
    ...
    /**
     * Returns the item margin. This is a percentage of the available space that
     * is allocated to the space between items in the chart.
     *
     * @return The margin.
     *
    ...
    /**
     * Returns the flag that controls whether or not the mean indicator is draw
     * for each item.
     *
     * @return A boolean.
     *
     ...
     * for each item, and sends a {@link RendererChangeEvent} to all registered
     * listeners.
     *
    ...
    /**
     * Returns the flag that controls whether or not the minimum outlier is draw
     * for each item.
     *
     * @return A boolean.
     *
    ...
    /**
     * Returns the flag that controls whether or not the maximum outlier is draw
     * for each item.
     *
     * @return A boolean.
     *
    ...
    /**
     * Returns the flag that, if {@code true}, causes the whiskers to be drawn
     * using the series outline paint.
     *
     * @return A boolean.
     */
    ...
    /**
     * Sets the flag that, if {@code true}, causes the whiskers to be drawn
     * using the series outline paint, and sends a {@link RendererChangeEvent}
    ...
    /**
     * Returns the range of values from the specified dataset that the renderer
     * will require to display all the data.
     *
            ...
            if (xMean != null) {
                ...
                if ((xxMean > (dataArea.getMinX() - aRadius))
                    ...
                    Ellipse2D.Double avgEllipse = new Ellipse2D.Double(xxMean
                            - 3 * aRadius, yy + aRadius, aRadius * 2, aRadius * 2);
                    g2.fill(avgEllipse);
                    g2.draw(avgEllipse);
                }
            }
    ...
    public void drawVerticalItem(Graphics2D g2, CategoryItemRendererState state,
        ...
        Number yMaxOut = bawDataset.getMaxOutlier(row, column);
        Number yMinOut = bawDataset.getMinOutlier(row, column);
        ...
        if (this.meanVisible) {
            ...
            if (yMean != null) {
                ...
                if ((yyAverage > (dataArea.getMinY() - aRadius))
                    ...
                    Ellipse2D.Double avgEllipse = new Ellipse2D.Double(
                            xx + 3 * aRadius, yyAverage - aRadius, aRadius * 2,
                            aRadius * 2);
                    g2.fill(avgEllipse);
                    g2.draw(avgEllipse);
                }
            ...
            System.out.println("bin: " + row + " dataset: " + column + " avg: " + Math.round(yMean.doubleValue() * 10.0) / 10.0 + " "
                    ...
                    + "|"+Math.round(yMedian.doubleValue() * 10.0) / 10.0 + "|"
                    + " "+Math.round(yQ3.doubleValue() * 10.0) / 10.0 + "||"
                    + ""+Math.round(yMax.doubleValue() * 10.0) / 10.0 + " ---|"
                    + " > "+Math.round(yMaxOut.doubleValue() * 10.0) / 10.0);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BoxAndWhiskerRendererUpgraded)) {
            return false;
        }
        BoxAndWhiskerRendererUpgraded that = (BoxAndWhiskerRendererUpgraded) obj;
