...
The data sets in SWF format are available at https://jsspp.org/workload/ and http://www.cs.huji.ac.il/labs/parallel/workload/logs.html. Sample data sets are provided within the distribution (see ./data-set and ./example directories) but only serve for demonstration purposes.
